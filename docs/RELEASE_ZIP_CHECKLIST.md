...
| `ae/Evotechly Transitions.jsx` | Window → Evotechly Transitions (Transition Kit Phase 0–2). Not part of the original 2.0.0 four-file zip — include it when packing the kit. | ~35 KB |
