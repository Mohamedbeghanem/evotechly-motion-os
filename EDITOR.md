...
| *(companion)* | **Window → SaaS Demo Tools / Motion OS Hub** — Home (Seed), SaaS (cursor, depth, stagger, UI presets, carousel, glass, wipe, hover, Flowing Text, Coloured Reveal), Kit Hub (official URLs) |
