...
- **Window > Evotechly Transitions** — Transition Kit Phase 1 (six UI Push plans + full catalog). See [docs/TRANSITION_KIT.md](docs/TRANSITION_KIT.md). Does not replace the v0.32 panel.
