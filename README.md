...
- **Window > Evotechly Transitions** — Transition Kit Phase 2 (UI Push) plus P1 native Text / UI / Cursor tabs. See [docs/TRANSITION_KIT.md](docs/TRANSITION_KIT.md) and [docs/SAAS_ASSETS_P1.md](docs/SAAS_ASSETS_P1.md). Does not replace the v0.32 panel.
