...
- **Window > Evotechly Transitions** — Transition Kit Phase 2 (full UI Push family + full catalog). See [docs/TRANSITION_KIT.md](docs/TRANSITION_KIT.md). Does not replace the v0.32 panel.
